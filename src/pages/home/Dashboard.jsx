          ...
          <ul className="menu p-4 w-80  h-full   bg-[#E8EAED]  text-black pt-[100px] lg:pt-6 ">
            ...
            <li>
              <div className="flex justify-start items-start gap-2 ">
                <Avatar sx={{ bgcolor: "#F000B8" }}>
                  {user ? user.name?.substring(0, 2).toUpperCase() : "NO"}
                </Avatar>
                <div className="mb-3">
                  <h6 className="text-[#1976D2] font-bold mb-0 text-[1.3em]">
                    {user?.name}
                  </h6>
            ...
            <li className="mb-2 ">
              ...
              >
                <CloudDownloadIcon /> Most Downloads
              </Link>
            </li>
            <li className="mb-2 ">
              <Link
              ...
              >
                <DriveFolderUploadIcon /> Upload Document
              </Link>
            </li>
